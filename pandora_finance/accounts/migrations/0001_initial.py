    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'empleado'), (2, 'cliente')])),
        ...
        migrations.AddConstraint(
            model_name='user',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('can_authorize', True), ('user_type', 1)), models.Q(('can_authorize', False), ('user_type__in', (1, 2))), _connector='OR'), name='can_authorize_only_employee'),
        ),
    ]
